                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control <?= session('errors') && isset(session('errors')['password']) ? 'is-invalid' : ''; ?>" name="password" value="<?= old('password', $admin['password'] ?? '') ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control <?= session('errors') && isset(session('errors')['pass_confirm']) ? 'is-invalid' : ''; ?>" name="pass_confirm" value="<?= old('pass_confirm', $admin['pass_confirm'] ?? '') ?>">
                                <div class="invalid-feedback">
