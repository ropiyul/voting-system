...
<style>
	...
	.login-brand img {
		...
		max-height: 250px;
		/* Tambahkan ini saja */
		filter: drop-shadow(0 3px 6px rgba(99, 99, 99, 0.15)) drop-shadow(0 1px 3px rgba(186, 186, 186, 0.1));
		-webkit-filter: drop-shadow(0 3px 6px rgba(99, 99, 99, 0.15)) drop-shadow(0 1px 3px rgba(186, 186, 186, 0.1));
	...
	.login-brand img:hover {
		...
		filter: drop-shadow(0 4px 8px rgba(158, 158, 158, 0.2)) drop-shadow(0 2px 4px rgba(186, 186, 186, 0.15));
		-webkit-filter: drop-shadow(0 4px 8px rgba(158, 158, 158, 0.2)) drop-shadow(0 2px 4px rgba(186, 186, 186, 0.15));
	}
</style>
			...
			<div class="row">
				<div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
					...
					<div class="mt-5 text-muted text-center">
						...
						<?php endif; ?>
						<div class=" mb-3">	
							Jika Anda mengalami kendala, mohon <a href="<?= url_to('chat') ?>">laporkan di sini</a>.
						</div>
